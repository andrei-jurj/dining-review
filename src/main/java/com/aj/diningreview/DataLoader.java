    ...
    private void loadData() {
        ...
        if (totalUsers == 0) {
            userRepository.saveAll(List.of(
                new User(totalUsers++, "john123", "somethig@gmail.com", "somepass","Barcelona", "Catalonia", "08001", false, false, true, true),
                new User(totalUsers++, "george2022", "somes", "george2022@gmail.com","Cluj-Napoca", "Cluj", "278114", false, true, false, true)
